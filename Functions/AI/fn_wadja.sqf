...
if (_urbanInfantrySetting) then {
    for "_x" from 1 to _urbanInfantryAmount do {
        ...
        private _returnedUnits = [_AOpos, nil, (units _group), (55), 2, false] call derp_fnc_AIOccupyBuilding;
...
if (_milbuildingInfantry) then {
    private _milBuildings = nearestObjects [_AOpos, MilitaryBuildings, (55)];
    ...
    if (_milBuildingCount > 0 ) then {
        ...
        for "_x" from 1 to 3 do {
            ...
            private _returnedUnits= [_AOpos, MilitaryBuildings, (units _group), (55), 2, false] call derp_fnc_AIOccupyBuilding;
