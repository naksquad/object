...
if (_urbanInfantrySetting) then {
    for "_x" from 1 to 2 do {
        ...
        private _returnedUnits = [_AOpos, nil, (units _group), (120), 2, false] call derp_fnc_AIOccupyBuilding;
...
if (_milbuildingInfantry) then {
    private _milBuildings = nearestObjects [_AOpos, MilitaryBuildings, (150)];
    ...
    if (_milBuildingCount > 0 ) then {
        ...
        for "_x" from 1 to 7 do {
            ...
            private _returnedUnits= [_AOpos, MilitaryBuildings, (units _group), (150), 2, false] call derp_fnc_AIOccupyBuilding;
