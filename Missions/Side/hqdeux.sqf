...
//-------------------- 2. SPAWN OBJECTIVES
	...
	towers = "Land_BagBunker_Large_F" createVehicle _flatPos4; 
	buka = "Land_BagBunker_Large_F" createVehicle _flatPos5; 
	buker = "Land_BagBunker_Large_F" createVehicle _flatPos6; 
...
//	_fuzzyPos = [((_flatPos select 0) - 300) + (random 600),((_flatPos select 1) - 300) + (random 600),0];
	...
	priorityTargetText = "Bunker";
	"priorityMarker" setMarkerText "Priority Target: Bunker";

    [west,["priorArtyTask"],["OPFOR forces are setting up an Bunker! We've picked up their positions with thermal imaging scans and have marked it on your map. This is a priority target, boys! They're just setting up now; they'll be firing in about five minutes!","Priority Target: Bunker","priorityCircle"],(getMarkerPos "priorityCircle"),0,0,true,"rifle",true] call BIS_fnc_taskCreate;
