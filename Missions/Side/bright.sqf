 ...
 private _claws = ["Agios_Camp_1"];
 currentAOFL = _claws call BIS_fnc_selectRandom;  
 sleep 5; 
 _pos = getMarkerPos currentAOFL; _mainUnits = [_pos, [true, true, true, true, true, true, true, true]] call derp_fnc_wadjaBright;
...
sideMarkerText = "Secure Agios Camp";
"sideMarker" setMarkerText "Side Mission: Secure Agios Camp";
[west,["tankTask"],["We have gotten reports that OpFor have sent some Spetsnaz at the Agios Camp. Get over there and kill them all Private. Be careful, our operatives have said that those Spetsnaz are powerful as the Seals.","Side Mission: Secure Agios Camp","bright_camp"],(getMarkerPos "bright_camp"),0,0,true,"target",true] call BIS_fnc_taskCreate;
sideMarkerText = "Secure Agios Camp";
	sleep 10;
