...
//-------------------- 5. SPAWN FORCE PROTECTION
	...
	_enemiesArray = [priorityObj1] call AW_fnc_PTenemyEAST;
...
["Anti-Air", "SUCCEEDED",true] call BIS_fnc_taskSetState;
sleep 5;
["Anti-Air",west] call bis_fnc_deleteTask;
