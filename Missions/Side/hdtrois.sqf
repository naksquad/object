...
//-------------------- 2. SPAWN OBJECTIVES
	...
	buka = "Land_Cargo_Tower_V1_F" createVehicle _flatPos5; 
	buker = "Land_Cargo_Tower_V1_F" createVehicle _flatPos6; 
...
//	_fuzzyPos = [((_flatPos select 0) - 300) + (random 600),((_flatPos select 1) - 300) + (random 600),0];
	...
	priorityTargetText = "FOB";
	"priorityMarker" setMarkerText "Priority Target: FOB";

    [west,["priorArtyTask"],["OPFOR forces are setting up an FOB! We've picked up their positions with thermal imaging scans and have marked it on your map. This is a priority target, boys! They're just setting up now; they'll be firing in about five minutes!","Priority Target: FOB","priorityCircle"],(getMarkerPos "priorityCircle"),0,0,true,"exit",true] call BIS_fnc_taskCreate;
